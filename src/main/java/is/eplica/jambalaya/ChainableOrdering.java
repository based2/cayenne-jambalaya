...
/**
 * Provides support for defining Orderings in a "chain". Especially useful in
 * combination with "Key".
 */

public class ChainableOrdering extends Ordering
{
    private static final long serialVersionUID = -6378716715587908337L;
    ...
    {
	private static final long serialVersionUID = 9202742642889035479L;
