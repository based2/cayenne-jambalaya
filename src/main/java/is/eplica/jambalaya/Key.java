...
import is.eplica.jambalaya.ChainableOrdering.ChainableOrderings;
...
public class Key<E>
{
  ...
  * @param upper
  *         The upper bound. [null] represents infinity.
  */
  ...
  */
    ...
    /**
     * @return An expression with the given expressions combined with logical
     *         "and".
     */
